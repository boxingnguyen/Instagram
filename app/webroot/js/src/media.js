				...
				if(data.length>0){
					for(var i = 0; i<data.length; i++){
                        ...
                        if(data[i].type == 'video'){
                            // add check album or not later
                            //...
                            // get url video
                            for (var k in data[i].videos){
                               if(data[i].videos.hasOwnProperty(k)){
                                   var resolution = data[i].videos[k];
                                   for (var l in resolution){
                                       if(resolution.hasOwnProperty(l)){
                                          var video_url = resolution[l];
                                       }
                                   }
                               }
                            }
                            ...
                            post = '<video class="pre-media" controls width="320" height="320"><source src="' + video_url + '" type="video/mp4"></video>';
                        }
                        var location = '';
